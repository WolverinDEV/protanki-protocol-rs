...
use tank_bot_rs::{packets::{self, PacketDowncast}, codec::CaptchaLocation, TanksClient};
use tracing::{debug};
...
pub async fn solve_captcha(client: &mut TanksClient, location: CaptchaLocation, solver: &mut dyn CaptchaSolver) -> anyhow::Result<bool> {
